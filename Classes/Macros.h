...
typedef enum //MENU
{
	...
	L_MAINMENU, B_PLAYSINGLE, B_PLAYMULTI, B_OPTIONS, B_BACK,
		L_PLAYSINGLE,LAB_SINGLEPLAYER, B_CARRER, B_FREERUN,
			L_CARRER, LAB_CARRER,
			L_FREERUN, LAB_FREERUN, LAB_CHOOSEMODE, PG_CHOOSEMODE, B_OPPONENTSSLIDE, B_DIFFICULTYSLIDER, LAB_OPPONENTSNUMBERSLIDER, B_FREERUNACCEPTANDPLAY, LAB_DIFFICULTYLABEL,LAB_GATESNUMBER,B_GATESLIDER,
		L_PLAYMULTI,
