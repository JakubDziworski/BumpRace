...
protected:
    float boxPlynnePrzejscieX = 0;
    float boxPlynnePrzejscieY = 0;
    int przejsciaiterations = 0;
...
public:
	...
	void generateBg();
	bool IsDisplayingTutorial() const { return isDisplayingTutorial; }
	void setIsDisplayingTutorial(bool val) { isDisplayingTutorial = val; if (val) pauseGame(); else resumeGame(); }
};
